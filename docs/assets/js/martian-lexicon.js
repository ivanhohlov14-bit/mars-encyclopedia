// ============================================================
// martian-lexicon.js — единый словарь марсианского языка
// Используется и в переводчике, и в режиме марсианского языка
// ============================================================
...
(function() {
    ...
    // 📚 ОСНОВНОЙ СЛОВАРЬ
    // ============================================================
    window.MARTIAN_LEXICON = {

        // 👇👇👇 СЮДА ВСТАВЬ ВЕСЬ СВОЙ LEXICON_DATA 👇👇👇
        // (открой docs/translator/index.md, скопируй весь объект
        //  от `"я": { root: "an", pos: "pron" },` до конца словаря)
...
// ============================================================
  ...
  "пещер под фарсидой": { root: "Khō-ān-sen", pos: "phrase" }
   ...
   // ============================================================
    // 🔤 ЛЕММЫ ГЛАГОЛОВ (для приведения к инфинитиву)
    // ============================================================
    window.MARTIAN_VERB_LEMMAS = {
    ...
    // 🎨 ПРОЧИЕ ДАННЫЕ
    // ============================================================
    window.MARTIAN_PREPOSITIONS = [
        'на','в','у','к','от','из','для','без','через','по','о','об',
        'с','со','за','под','над','перед','между','возле','около','мимо','вокруг'
    ];

    window.MARTIAN_PLURAL_WORDS = [
        'звёзды','звезды','звёзд','звезд','воды','вод','реки','рек','горы','гор',
        'люди','людей','марсиане','марсиан','дома','домов','столы','столов',
        'стулья','стульев','кровати','кроватей','леса','лесов','поля','полей',
        'дети','детей','глаза','глаз'
    ];

    console.log('🪐 Словарь загружен: ' + Object.keys(window.MARTIAN_LEXICON).length + ' слов');
})();
