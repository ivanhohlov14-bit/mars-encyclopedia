<!-- В extra_javascript → assets/js/vip-cursor.js -->
<style>
  * { cursor: none !important; }
  #vip-cursor {
    ...
    box-shadow: 0 0 20px #6C63FF, 0 0 40px rgba(108,99,255,0.4);
...
<script>
(function() {
  if (window.innerWidth < 768) return; // на мобильном не нужно
  ...
  document.addEventListener('mouseover', function(e) {
    if (e.target.closest('a, button, .pf-btn, .pf-tab')) {
