// vip-scroll-reveal.js — плавное появление блоков при прокрутке
(function() {
    'use strict';

    var style = document.createElement('style');
    style.textContent = [
        '.vip-reveal { opacity: 0; transform: translateY(40px); transition: all 0.8s cubic-bezier(0.16, 1, 0.3, 1); }',
        '.vip-reveal.visible { opacity: 1; transform: translateY(0); }'
    ].join('\n');
