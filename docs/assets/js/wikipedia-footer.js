...
(function() {
    ...
    var CONFIG = {
        ...
        licenseNote: 'Материалы «Марсианской энциклопедии» доступны по лицензии Creative Commons «Attribution-NonCommercial-NoDerivs» (BY-NC-ND) 4.0. Отдельные элементы могут иметь собственные условия использования — см. страницу лицензии. Подробнее см. <a href="/license/" style="color:inherit;text-decoration:underline;">Условия использования</a>.',

        // Второй абзац (бренд)
        brandNote: '<strong>' + 'Марсианская энциклопедия' + '®</strong> — проект сообщества исследователей Марса. Материалы публикуются, без гарантий точности.',
