...
:root{
    ...
    --hor-k-light:#A29BFE;
    --hor-k-bg:#F0F4FF;
    --hor-k-shadow:rgba(108,99,255,.25);
}
#hor-app{
    max-width: 1000px;
    margin: 0 auto;
...
@keyframes horGlow{0%,100%{box-shadow:0 0 30px var(--hor-k-shadow)}50%{box-shadow:0 0 60px var(--hor-k-shadow)}}
...
@keyframes horReveal{
    0%{opacity:0;transform:scale(.94) rotate(-2deg)}
    100%{opacity:1;transform:scale(1) rotate(0)}
}
@keyframes horTwinkle{
    0%,100%{opacity:.4;transform:scale(1)}
    50%{opacity:1;transform:scale(1.3)}
}
@keyframes horParticle{
...
.hor-spinner{
    ...
    border:4px solid var(--hor-k-shadow);border-top-color:var(--hor-k);
...
.hor-star{
    ...
    animation:horTwinkle 3s ease-in-out infinite;
}
...
.hor-hero::before{
    ...
    animation:horFloat 10s ease-in-out infinite;
    pointer-events:none;
}
.hor-hero::after{
    content:'';
    ...
    animation:horFloat 12s ease-in-out infinite reverse;
    pointer-events:none;
}
...
.hor-hero-wheel{
    ...
    opacity:.18;
    pointer-events:none;
    animation:horRotate 120s linear infinite;
}
...
.hor-hero-icon{
    ...
    filter:drop-shadow(0 8px 32px rgba(162,155,254,.8));
}
.hor-hero-title{
...
.hor-hero-sub{
    font-size:.95rem;opacity:.85;margin:0 0 18px;
    line-height:1.6;
}
.hor-date-badge{
...
.hor-mode-tab{
    ...
    color:#666;font-size:.85rem;font-weight:800;
...
.hor-signs-title .hor-title-count{
    ...
    color:var(--hor-k);font-weight:800;
}
...
.hor-sign::before{
    ...
    background:var(--sign-color,var(--hor-k));
...
.hor-sign-dates{
    font-size:.65rem;color:#888;font-weight:700;
    letter-spacing:.3px;
}
.hor-sign-fav{
...
.hor-result{
    ...
    border-radius:24px;
    border:2px solid var(--hor-k);
    padding:0;
    margin-bottom:24px;
    box-shadow:0 20px 60px -16px var(--hor-k-shadow);
    position:relative;
    overflow:hidden;
    animation:horReveal .6s cubic-bezier(.16,1,.3,1);
}
.hor-result::before{
    content:'';position:absolute;
    top:-50%;right:-20%;
    width:500px;height:500px;
    background:radial-gradient(circle,var(--hor-k),transparent 70%);
...
.hor-result-head{
    ...
    background:linear-gradient(135deg,
        color-mix(in srgb, var(--hor-k) 6%, transparent),
        transparent);
...
.hor-result-tab{
    padding:12px 18px;
    border:none;background:transparent;
    color:#888;font-size:.85rem;font-weight:800;
...
.hor-result-tab.active{
    color:var(--hor-k);
    border-bottom-color:var(--hor-k);
}
.hor-result-tab.active::after{
    content:'';
    position:absolute;bottom:-1px;left:20%;right:20%;height:3px;
    background:var(--hor-k);
    border-radius:3px 3px 0 0;
    box-shadow:0 0 12px var(--hor-k);
}
...
.hor-result-text{
    ...
    color:#2a2a3e;
    padding:16px 20px;
    border-left:4px solid var(--hor-k);
    background:linear-gradient(135deg,
        color-mix(in srgb, var(--hor-k) 5%, transparent),
        transparent);
...
.hor-result-text::before{
    content:'«';position:absolute;
    top:-10px;left:8px;
    font-size:3rem;color:var(--hor-k);
    opacity:.3;line-height:1;
}
.hor-result-text::after{
    content:'»';position:absolute;
...
.hor-quality{
    ...
    text-align:center;
    transition:all .25s cubic-bezier(.16,1,.3,1);
    animation:horFadeIn .5s ease both;
}
.hor-quality:hover{
    transform:translateY(-3px);
    border-color:var(--hor-k);
...
.hor-btn.outline{
    background:transparent;color:var(--hor-k);
    border-color:var(--hor-k);
    box-shadow:none;
}
...
.hor-btn.success{
    ...
    box-shadow:0 6px 16px -4px rgba(39,174,96,.4);
}
.hor-btn:disabled{
...
.hor-section-title .hor-section-sub{
    font-size:.75rem;color:#888;font-weight:700;margin-left:auto;
}
...
.hor-day.today{
    ...
    color:#fff;
    border-color:var(--hor-k);
    box-shadow:0 8px 20px -4px var(--hor-k-shadow);
    transform:translateY(-3px);
}
...
.hor-htab.active{
    background:#fff;color:var(--hor-k);
...
.hor-empty-icon{font-size:3rem;opacity:.5;margin-bottom:12px}
...
.hor-toast.show{
    animation:horToastIn .4s cubic-bezier(.16,1,.3,1) forwards;
    opacity:1;
}
.hor-toast.hide{
    animation:horToastOut .3s ease forwards;
}
...
@media (prefers-color-scheme: dark){
    html body.mars-stars-on .hor-sign,
    html body.mars-stars-on .hor-result,
    html body.mars-stars-on .hor-day,
    html body.mars-stars-on .hor-quality,
    html body.mars-stars-on .hor-history-item,
    html body.mars-stars-on .hor-mode-tabs,
    html body.mars-stars-on .hor-compat-card,
    html body.mars-stars-on .hor-empty{
        background:rgba(20,20,42,.9);
        border-color:rgba(108,99,255,.3);
        color:#e0e0f0;
    }
    html body.mars-stars-on .hor-sign-name,
    html body.mars-stars-on .hor-result-sign,
    html body.mars-stars-on .hor-section-title,
    html body.mars-stars-on .hor-day-num,
    html body.mars-stars-on .hor-compat-name{color:#e0e0f0}
    html body.mars-stars-on .hor-result-text{color:#d0d0e0;background:rgba(108,99,255,.08)}
    html body.mars-stars-on .hor-history-text{color:#aaa}
    html body.mars-stars-on .hor-mode-tab{color:#aaa}
    html body.mars-stars-on .hor-mode-tab.active{color:#fff}
    html body.mars-stars-on .hor-htab{color:#aaa}
    html body.mars-stars-on .hor-htab.active{background:#252550;color:#A29BFE}
    html body.mars-stars-on .hor-history-tabs{background:rgba(255,255,255,.05)}
}
...
/* ═══════════════════ 8 MARTIAN SIGNS ═══════════════════ */
var MARTIAN_SIGNS = [
    { id:'akha-dzen', name:'Ākha-dzen', ru:'Водная Звезда', icon:'🌊',
      dates:'Пробуждение', color:'#3498db', element:'Вода', months:[0,1],
      stone:'Аквамарин', planet:'Фобос', ruler:'Хевсур' },
    { id:'dzen-akha', name:'Dzen-ākha', ru:'Звёздная Вода', icon:'💧',
      dates:'Цветение', color:'#1abc9c', element:'Вода', months:[2,3],
      stone:'Жемчуг', planet:'Деймос', ruler:'Алира' },
    { id:'mar-dzen', name:'Mar-dzen', ru:'Жизнь-Звезда', icon:'🌟',
      dates:'Зной', color:'#e74c3c', element:'Огонь', months:[4,5],
      stone:'Рубин', planet:'Солнце', ruler:'Сарум' },
    { id:'zal-akha', name:'Zal-ākha', ru:'Ветряная Вода', icon:'🌪️',
      dates:'Ветры', color:'#95a5a6', element:'Воздух', months:[6,7],
      stone:'Топаз', planet:'Юпитер', ruler:'Ксанф' },
    { id:'kol-ghar', name:'Kōl-ghar', ru:'Каменная Земля', icon:'⛰️',
      dates:'Угасание', color:'#7f8c8d', element:'Земля', months:[8,9],
      stone:'Гранит', planet:'Сатурн', ruler:'Йарра' },
    { id:'dzen-kol', name:'Dzen-kōl', ru:'Звёздная Земля', icon:'🏔️',
      dates:'Заморозки', color:'#34495e', element:'Земля', months:[10,11],
      stone:'Обсидиан', planet:'Марс', ruler:'Аратан III' },
    { id:'lan-sen', name:'Lān-sen', ru:'Место Памяти', icon:'🕯️',
      dates:'Тьма', color:'#8e44ad', element:'Дух', months:[12,13,14],
      stone:'Аметист', planet:'Луна', ruler:'Совия' },
    { id:'kol-suf', name:'Kōl-suf', ru:'Великая Земля', icon:'❄️',
      dates:'Ледяной покров', color:'#5dade2', element:'Лёд', months:[15,16,17,18,19,20,21],
      stone:'Алмаз', planet:'Уран', ruler:'Мнемис' }
];

/* ═══════════════════ 12 EARTH ZODIAC SIGNS ═══════════════════ */
var EARTH_SIGNS = [
    { id:'aries',   name:'Aries',       ru:'Овен',       icon:'♈', dates:'21.03–19.04', color:'#e74c3c', element:'Огонь', months:[2,3],
      stone:'Алмаз', planet:'Марс', ruler:'Арес' },
    { id:'taurus',  name:'Taurus',      ru:'Телец',      icon:'♉', dates:'20.04–20.05', color:'#27ae60', element:'Земля', months:[3,4],
      stone:'Изумруд', planet:'Венера', ruler:'Тельпу' },
    { id:'gemini',  name:'Gemini',      ru:'Близнецы',   icon:'♊', dates:'21.05–20.06', color:'#f39c12', element:'Воздух', months:[4,5],
      stone:'Агат', planet:'Меркурий', ruler:'Кастор' },
    { id:'cancer',  name:'Cancer',      ru:'Рак',        icon:'♋', dates:'21.06–22.07', color:'#3498db', element:'Вода', months:[5,6],
      stone:'Лунный камень', planet:'Луна', ruler:'Артемида' },
    { id:'leo',     name:'Leo',         ru:'Лев',        icon:'♌', dates:'23.07–22.08', color:'#f5d76e', element:'Огонь', months:[6,7],
      stone:'Янтарь', planet:'Солнце', ruler:'Гелиос' },
    { id:'virgo',   name:'Virgo',       ru:'Дева',       icon:'♍', dates:'23.08–22.09', color:'#16a085', element:'Земля', months:[7,8],
      stone:'Сапфир', planet:'Меркурий', ruler:'Астрея' },
    { id:'libra',   name:'Libra',       ru:'Весы',       icon:'♎', dates:'23.09–22.10', color:'#9b59b6', element:'Воздух', months:[8,9],
      stone:'Опал', planet:'Венера', ruler:'Фемида' },
    { id:'scorpio', name:'Scorpio',     ru:'Скорпион',   icon:'♏', dates:'23.10–21.11', color:'#8e44ad', element:'Вода', months:[9,10],
      stone:'Топаз', planet:'Плутон', ruler:'Гадес' },
    { id:'sagittarius', name:'Sagittarius', ru:'Стрелец', icon:'♐', dates:'22.11–21.12', color:'#e67e22', element:'Огонь', months:[10,11],
      stone:'Бирюза', planet:'Юпитер', ruler:'Хирон' },
    { id:'capricorn', name:'Capricorn', ru:'Козерог',    icon:'♑', dates:'22.12–19.01', color:'#546e7a', element:'Земля', months:[11,0],
      stone:'Гранит', planet:'Сатурн', ruler:'Кронос' },
    { id:'aquarius',  name:'Aquarius',  ru:'Водолей',    icon:'♒', dates:'20.01–18.02', color:'#4dd0e1', element:'Воздух', months:[0,1],
      stone:'Аквамарин', planet:'Уран', ruler:'Ганимед' },
    { id:'pisces',    name:'Pisces',    ru:'Рыбы',       icon:'♓', dates:'19.02–20.03', color:'#5dade2', element:'Вода', months:[1,2],
      stone:'Жемчуг', planet:'Нептун', ruler:'Посейдон' }
];
...
var OPENINGS = [
    ...
    'Фобос замер над горизонтом',
    'Деймос скрылся за облаком',
    'Река Ксанф поёт древнюю песню',
    'Тени в пещерах стали длиннее',
    'Звёздное небо сегодня ярче обычного',
    'Луна прошла через созвездие Хевсура',
    'Пепел Тарсиса поднялся в воздух',
    'Олимп укутан облаками предзнаменований',
    'Ледники Эритрея треснули',
    'Птицы летят на юг раньше срока'
];
var MIDDLES = [
    ...
    'встреча с мудрым человеком изменит взгляд',
    ...
    'твоя идея найдёт отклик у других',
    'заверши то, что начал давно'
];
var WARNINGS = [
    ...
    'но не позволяй гордыне взять верх',
    'и пусть терпение будет твоим щитом'
];
var CLOSINGS = [
    ...
    'Пусть Ацидалийское море успокоит твой дух.',
    'И глина, и вода — свидетели твои.'
];
...
var COLORS = [
    ...
    { name:'Золотой', hex:'#f5d76e' },
    { name:'Серебряный', hex:'#bdc3c7' },
...
function getSignForMartianMonth(mi){
    return MARTIAN_SIGNS.filter(function(s){ return s.months.indexOf(mi) !== -1; })[0] || MARTIAN_SIGNS[0];
}
function getSignForEarthDate(date){
    var m = date.getMonth(), d = date.getDate();
    // Упрощённо по месяцу
    return EARTH_SIGNS.filter(function(s){ return s.months.indexOf(m) !== -1; })[0] || EARTH_SIGNS[0];
}
function getSigns(){ return state.mode === 'martian' ? MARTIAN_SIGNS : EARTH_SIGNS; }
...
function generateQualities(signId, dayKey){
    ...
    return {
        ...
        color: pick(COLORS, seed >> 4),
        number: (seed % 22) + 1,
        focus: pick(FOCUS_AREAS, seed >> 5),
        focusTip: pick(FOCUS_AREAS[(seed >> 5) % FOCUS_AREAS.length].tips, seed >> 7)
    };
}

function getCompatibility(sign){
    var pool = getSigns().filter(function(s){ return s.id !== sign.id; });
    var seed = hashCode(sign.id + 'compat');
    var good = pool[seed % pool.length];
    var warn = pool[(seed >> 3) % pool.length];
    while (warn.id === good.id) warn = pool[(seed >> 3) + 1 % pool.length];
    var bad = pool[(seed >> 6) % pool.length];
    while (bad.id === good.id || bad.id === warn.id) bad = pool[(seed >> 6) + 1 % pool.length];
    return { good: good, warn: warn, bad: bad };
}
        ...
        if (state.currentUser){
            ...
            if (state.profile && state.profile.zodiac_sign){
                ...
                if (found){
                    ...
                    SIGNS = foundMode === 'martian' ? MARTIAN_SIGNS : EARTH_SIGNS;
...
async function loadCloud(){
    ...
    try{
        var r = await sb.from('horoscope_history')
            .select('*')
    ...
    try{
        ...
        if (r.error){
            if (r.error.code === '23505'){
                toast('Уже сохранено сегодня', 'info');
                return false;
            }
        ...
        try{
            ...
            if (lastDay !== today){
                ...
                if (lastDay === yKey) newStreak = state.streak + 1;
                else newStreak = 1;
                await sb.from('profiles').update({
                    horoscope_streak: newStreak,
                    horoscope_last_day: today
                }).eq('user_id', state.currentUser.id);
...
async function saveFavorite(sign){
    if (!state.currentUser || !sb){
        toast('Войдите, чтобы сохранить любимый знак', 'warning');
        return;
    }
    try{
        await sb.from('profiles').update({
            zodiac_sign: sign.id,
            zodiac_mode: state.mode
        }).eq('user_id', state.currentUser.id);
        if (state.profile){
...
function render(){
    ...
    if (!state.activeSign || !signs.some(function(s){ return s.id === state.activeSign.id; })){
        if (state.mode === 'martian'){
            state.activeSign = getSignForMartianMonth(martian.monthIndex);
        } else {
            state.activeSign = getSignForEarthDate(new Date());
        }
    }
    ...
    return '<div class="hor-hero hor-fade">' +
        ...
        '<div class="hor-hero-content">' +
            ...
            '<div>' +
                ...
                (state.streak > 0
                    ? '<div class="hor-streak">🔥 Стрик: ' + state.streak + ' дн.</div>'
                    : '') +
            '</div>' +
        '</div>' +
    '</div>';
...
function renderZodiacWheel(){
    ...
    for (var i = 0; i < n; i++){
        ...
        var x1 = cx + Math.cos(a1) * r2, y1 = cy + Math.sin(a1) * r2;
        var x2 = cx + Math.cos(a2) * r2, y2 = cy + Math.sin(a2) * r2;
        var x3 = cx + Math.cos(a2) * r1, y3 = cy + Math.sin(a2) * r1;
        var x4 = cx + Math.cos(a1) * r1, y4 = cy + Math.sin(a1) * r1;
        var color = signs[i].color;
        parts.push('<path d="M' + x1 + ',' + y1 + ' L' + x2 + ',' + y2 + ' L' + x3 + ',' + y3 + ' L' + x4 + ',' + y4 + ' Z" fill="' + color + '" stroke="rgba(255,255,255,.4)" stroke-width="1"/>');
        var am = (a1 + a2) / 2;
        var tx = cx + Math.cos(am) * (r1 + 18);
        var ty = cy + Math.sin(am) * (r1 + 18);
    ...
    return '<h3 class="hor-signs-title hor-fade">' + title +
        ...
        signs.map(function(s){
            ...
            return '<button class="hor-sign ' + (isActive ? 'active' : '') + '" ' +
                ...
                '<div class="hor-sign-dates">' + esc(state.mode === 'martian' ? s.dates : s.dates) + '</div>' +
            '</button>';
        }).join('') +
    '</div>';
}
...
function renderResult(sign, text, qualities, compat, nativeSign){
    var isNative = sign.id === nativeSign.id;
...
function renderHistory(){
    ...
    var title = state.histTab === 'cloud' ? '☁️ Мои гороскопы' : '📚 Локальные';
...
function renderHistoryItem(h, i){
    ...
    return '<div class="hor-history-item" style="animation-delay:' + Math.min(i * .05, .4) + 's;" onclick="horSelectSign(\'' + escAttr(sign.id) + '\')">' +
...
window.horMode = function(mode){
    ...
    state.mode = mode;
    SIGNS = mode === 'martian' ? MARTIAN_SIGNS : EARTH_SIGNS;
...
window.horSaveCloud = async function(){
    ...
    if (ok){
        saveToLocal(state.activeSign, text);
        render();
    }
};
...
function loadFromURL(){
    try{
        ...
        var s = p.get('sign');
        var m = p.get('mode');
        if (m === 'earth' || m === 'martian'){
            state.mode = m;
            SIGNS = m === 'martian' ? MARTIAN_SIGNS : EARTH_SIGNS;
        }
        if (s){
...
async function init(){
    ...
    loadFromURL();
    render();
    console.log('🔮 Гороскоп v2 VIP готов. Режим: ' + state.mode + ', знаков: ' + getSigns().length);
}
