...
/* ═══════════════════════════════════════════════════════════
   БАЗОВЫЕ АНИМАЦИИ
   ═══════════════════════════════════════════════════════════ */
:root{--kc:#6C63FF;--kl:#A29BFE;--ks:rgba(108,99,255,.25);--kb:#F0F4FF;--vip-gold:#f5d76e;--vip-orange:#f39c12;--vip-dark:#e67e22}
...
.pf-hero::after{content:'';position:absolute;bottom:-60%;left:-10%;width:400px;height:400px;background:radial-gradient(circle,rgba(231,76,60,.15),transparent 70%);border-radius:50%;animation:pfFloat 10s ease-in-out infinite reverse;pointer-events:none;z-index:0}
.pf-hero.pf-hero-vip::before{background:radial-gradient(circle,rgba(243,156,18,.35),transparent 70%)}
...
.pf-avatar-ring{position:absolute;inset:-10px;border:2px dashed var(--kl);border-radius:50%;animation:pfRing 18s linear infinite;opacity:.5;pointer-events:none;z-index:0}
.pf-avatar{width:120px!important;height:120px!important;max-width:120px!important;max-height:120px!important;aspect-ratio:1/1;border-radius:50%!important;border:4px solid rgba(255,255,255,.4)!important;object-fit:cover!important;background:#fff;box-shadow:0 12px 32px rgba(0,0,0,.2);position:relative;z-index:1;display:block}
.vip-avatar-frame{position:relative;display:inline-block;padding:4px;border-radius:50%;background-size:200% 200%;animation:vipFrameSpin 8s linear infinite;z-index:2;line-height:0;width:auto;height:auto}
...
.vip-avatar-frame > img.pf-avatar{border:3px solid #14142a!important;width:120px!important;height:120px!important;max-width:120px!important;max-height:120px!important}
...
.pf-email{font-size:.9rem;opacity:.85;margin:0 0 14px 0;position:relative;z-index:5}
.pf-stats{display:flex;gap:14px;flex-wrap:wrap;align-items:center;margin-bottom:14px;position:relative;z-index:5}
...
.pf-stat-item:hover{background:rgba(255,255,255,.15);transform:translateY(-2px)}
.pf-stat-label{font-size:.68rem;opacity:.85;text-transform:uppercase;letter-spacing:.8px;font-weight:700}
...
.pf-currency-click{cursor:pointer;padding:8px 14px;border-radius:12px;background:rgba(243,156,18,.2);border:1px solid rgba(243,156,18,.5);transition:all .25s;display:inline-flex;align-items:center;gap:8px;font-weight:800;color:#ffdf5e;position:relative;z-index:5}
.pf-currency-click:hover{background:rgba(243,156,18,.35);transform:translateY(-2px);box-shadow:0 8px 20px -4px rgba(243,156,18,.5)}
.pf-progress-bar{margin-top:12px;height:10px;background:rgba(0,0,0,.3);border-radius:12px;overflow:hidden;position:relative;z-index:5}
...
.pf-progress-text{font-size:.76rem;opacity:.9;margin-top:6px;position:relative;z-index:5}
...
.pf-mypage.pf-mypage-vip::before{background:linear-gradient(90deg,#f5d76e,#f39c12,#e67e22,#f5d76e);background-size:200% auto;animation:pfShine 2s linear infinite}
...
.pf-mypage-tile{background:linear-gradient(135deg,var(--kb),#fff);border:1px solid rgba(108,99,255,.15);border-radius:14px;padding:14px 16px;transition:all .3s;cursor:pointer;position:relative;overflow:hidden}
.pf-mypage-tile:hover{transform:translateY(-3px);box-shadow:0 12px 28px -8px var(--ks);border-color:var(--kc)}
.pf-mypage-vip .pf-mypage-tile{background:linear-gradient(135deg,rgba(245,215,110,.15),#fff);border-color:rgba(243,156,18,.25)}
.pf-mypage-vip .pf-mypage-tile:hover{border-color:var(--vip-orange);box-shadow:0 12px 28px -8px rgba(243,156,18,.5)}
...
.pf-mypage-vip .pf-mypage-tile-value{color:var(--vip-dark)}
...
.pf-note{background:#fff;border-radius:14px;padding:16px;border-left:4px solid var(--kc);box-shadow:0 4px 12px rgba(0,0,0,.06);cursor:pointer;transition:all .3s;position:relative;animation:pfFadeIn .3s ease both}
...
.pf-note-actions button{width:24px;height:24px;border-radius:6px;border:none;background:rgba(0,0,0,.05);font-size:.75rem;cursor:pointer;color:#666;padding:0;transition:all .2s}
...
.pf-icon-btn{width:32px;height:32px;border-radius:50%;border:1.5px solid rgba(0,0,0,.08);background:#fff;color:#666;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;font-size:.9rem;font-family:inherit;padding:0;transition:all .2s}
...
.pf-lb-name{display:inline-flex;align-items:center;gap:5px;flex-wrap:wrap}
...
.pf-chat-msg{margin:6px 0;padding:11px 16px;border-radius:16px;max-width:82%;word-wrap:break-word;font-size:.9rem;line-height:1.55;animation:pfFadeIn .3s ease both}
...
.pf-chat-link{display:inline-flex;align-items:center;gap:6px;padding:6px 12px;background:rgba(108,99,255,.08);border-radius:10px;color:var(--kc);font-size:.82rem;font-weight:700;transition:all .2s}
...
.pf-avatar-option{width:64px!important;height:64px!important;max-width:64px!important;max-height:64px!important;aspect-ratio:1/1;border-radius:50%;cursor:pointer;border:3px solid transparent;object-fit:cover;transition:all .25s;background:#f0f0f5;display:block}
...
.pf-frame-preview img{width:42px!important;height:42px!important;max-width:42px!important;max-height:42px!important;border-radius:50%;object-fit:cover;border:2px solid #fff;aspect-ratio:1/1;display:block}
...
.pf-modal{background:#fff;border-radius:20px;padding:28px;max-width:480px;width:100%;box-shadow:0 24px 70px -12px rgba(0,0,0,.5);animation:pfFadeIn .35s cubic-bezier(.16,1,.3,1);margin:auto}
...
/* ═══════════════════════════════════════════════════════════
   TOAST
   ═══════════════════════════════════════════════════════════ */
.pf-toast{position:fixed;bottom:30px;left:50%;transform:translateX(-50%) translateY(120px);padding:12px 26px;border-radius:30px;font-weight:700;font-size:.9rem;box-shadow:0 12px 32px rgba(0,0,0,.3);z-index:999999;transition:transform .4s cubic-bezier(.16,1,.3,1);color:#fff;max-width:90vw;text-align:center}
...
@media(max-width:600px){
  .pf-hero{padding:26px 20px;border-radius:18px}
  .pf-avatar{width:90px!important;height:90px!important;max-width:90px!important;max-height:90px!important}
  .vip-avatar-frame > img.pf-avatar{width:90px!important;height:90px!important;max-width:90px!important;max-height:90px!important}
...
var K_SESS = 'mars-auth-v1';
var K_SB = 'sb-ncytbgbzfjfoqmmgfygz-auth-token';
var K_BAK = 'mars-auth-backup';
var K_CACHE = 'mars-profile-cache-v6';
var K_ACT = 'mars-activity-v1';
var K_XP = 'mars-xp-history';
