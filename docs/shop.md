...
<div class="sh-hero sh-observe">
  ...
  <div class="sh-hero-content">
    ...
    <div class="sh-hero-meta">
      <span class="sh-meta-item">📦 5 товаров</span>
...
<div id="sh-forms" aria-hidden="true">
  <form target="_blank" id="sh-form-tablets" action="https://yookassa.ru/integration/simplepay/payment" method="post" accept-charset="utf-8">
    ...
    <input type="hidden" name="shopSuccessURL" value="https://mars-wiki.ru/payment-success/">
    <input type="hidden" name="shopFailURL" value="https://mars-wiki.ru/payment-error/">
    <input type="hidden" name="customerNumber" value="">
    <input type="hidden" name="cms_product_id" value="sh-form-tablets">
  ...
  <form target="_blank" id="sh-form-100" action="https://yookassa.ru/integration/simplepay/payment" method="post" accept-charset="utf-8">
    ...
    <input type="hidden" name="shopFailURL" value="https://mars-wiki.ru/payment-error/">
    <input type="hidden" name="customerNumber" value="">
    <input type="hidden" name="cms_product_id" value="sh-form-100">
  ...
  <form target="_blank" id="sh-form-500" action="https://yookassa.ru/integration/simplepay/payment" method="post" accept-charset="utf-8">
    ...
    <input type="hidden" name="shopFailURL" value="https://mars-wiki.ru/payment-error/">
    <input type="hidden" name="customerNumber" value="">
    <input type="hidden" name="cms_product_id" value="sh-form-500">
    <input type="hidden" name="sum" value="290">
    <input type="hidden" name="shopId" value="1474664">
  </form>
  ...
  <form target="_blank" id="sh-form-1000" action="https://yookassa.ru/integration/simplepay/payment" method="post" accept-charset="utf-8">
    ...
    <input type="hidden" name="shopFailURL" value="https://mars-wiki.ru/payment-error/">
    <input type="hidden" name="customerNumber" value="">
    <input type="hidden" name="cms_product_id" value="sh-form-1000">
    <input type="hidden" name="sum" value="490">
    <input type="hidden" name="shopId" value="1474664">
  </form>
  ...
  <form target="_blank" id="sh-form-vip" action="https://yookassa.ru/integration/simplepay/payment" method="post" accept-charset="utf-8">
    ...
    <input type="hidden" name="shopFailURL" value="https://mars-wiki.ru/payment-error/">
    <input type="hidden" name="customerNumber" value="">
    <input type="hidden" name="cms_product_id" value="sh-form-vip">
...
.sh-card.sh-card-super{
  ...
  animation:shFadeIn .4s ease both, shSuperPulse 2.5s ease-in-out infinite;
}
...
/* ═══ CARD BODY ═══ */
.sh-card-body{flex:1;padding:12px 22px 20px;display:flex;flex-direction:column}
.sh-card-cat{
...
.sh-card-desc{font-size:.85rem;color:#666;line-height:1.6;margin-bottom:14px;flex:1}
...
.sh-how-item::before{content:'';position:absolute;top:0;left:0;right:0;height:4px;background:linear-gradient(90deg,#f39c12,#f5d76e)}
.sh-how-item:hover{transform:translateY(-6px);border-color:#f39c12;box-shadow:0 20px 50px -14px rgba(243,156,18,.35)}
.sh-how-num{position:absolute;top:14px;right:18px;font-size:2.4rem;font-weight:900;color:rgba(243,156,18,.1);line-height:1;font-variant-numeric:tabular-nums}
.sh-how-icon{font-size:2.4rem;margin-bottom:12px;line-height:1}
.sh-how-title{font-size:1rem;font-weight:900;color:#1a1a2e;margin-bottom:10px;letter-spacing:-.2px}
.sh-how-text{font-size:.88rem;color:#555;line-height:1.7}

/* ═══ FAQ ═══ */
.sh-faq{display:flex;flex-direction:column;gap:10px;margin-bottom:24px}
.sh-faq-item{
  background:#fff;border-radius:14px;
  border:2px solid rgba(0,0,0,.05);overflow:hidden;
  transition:all .3s cubic-bezier(.16,1,.3,1);
}
.sh-faq-item:hover{border-color:rgba(243,156,18,.3);box-shadow:0 8px 24px -6px rgba(243,156,18,.2)}
.sh-faq-item[open]{border-color:#f39c12;box-shadow:0 12px 32px -8px rgba(243,156,18,.3)}
.sh-faq-item summary{
...
.sh-faq-answer a{color:#f39c12;font-weight:700;text-decoration:underline!important}
...
.sh-modal{
  ...
  text-align:center;
  box-shadow:0 30px 80px rgba(0,0,0,.5),0 0 0 2px rgba(243,156,18,.4) inset;
...
.sh-modal-icon{
  ...
  animation:shFloat 2s ease-in-out infinite;
}
...
@media (prefers-color-scheme: dark){
  ...
  html body.mars-stars-on #shop-app .sh-faq-item summary,
  html body.mars-stars-on #shop-app .sh-modal-title{color:#e0e0f0}
  ...
  html body.mars-stars-on #shop-app .sh-faq-answer,
  html body.mars-stars-on #shop-app .sh-modal-desc{color:#c0c0d0}
  ...
  html body.mars-stars-on #shop-app .sh-modal-field input{background:#1a1a30;color:#e0e0f0;border-color:rgba(243,156,18,.3)}
  html body.mars-stars-on #shop-app .sh-btn-secondary{background:#1a1a30;color:#ccc;border-color:rgba(243,156,18,.3)}
}
...
var PRODUCTS = [
  ...
  // ─── 500 талантов — 3 монеты ───
  {
    ...
    price:290, priceOld:500, save:42,
  ...
  // ─── 1000 талантов — 6 монет ───
  {
    ...
    price:490, priceOld:1000, save:51,
  ...
  // ─── VIP — корона ───
  {
    ...
    color:'#f39c12', colorLight:'#f5d76e', colorShadow:'rgba(243,156,18,.5)'
  }
];
...
function renderIcon(p){
  ...
  if (p.iconType === 'vip'){
    return '<div class="sh-vip-box"><div class="sh-vip-crown">👑</div></div>';
  }
  return '';
}
