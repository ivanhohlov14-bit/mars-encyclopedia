...
const VERB_LEMMAS = {
  ...
  "посмотрю": "посмотреть", "посмотришь": "посмотреть", "посмотрит": "посмотреть", 
  "посмотрим": "посмотреть", "посмотрите": "посмотреть", "посмотрят": "посмотреть", 
  "посмотрел": "посмотреть", "посмотрела": "посмотреть", "посмотрели": "посмотреть",
  "пойду": "пойти", "пойдёшь": "пойти", "пойдёт": "пойти", "пойдём": "пойти", "пойдёте": "пойти",
