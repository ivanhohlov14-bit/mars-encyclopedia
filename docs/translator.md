...
const MARTIAN_GLYPHS = {
  ...
  "khan": "|c",     // река (палка вертикальная с буквой "С" в ней)
  "sen": "P",       // место (символ похож на букву Р, но с несоприкасающейся линией)
  "īn": "∆",        // суффикс мужского рода (треугольник без нижней линии)
...
const MARTIAN_ALPHABET = {
  ...
  'ts': '✖',       // крестик
  'dz': '✙',       // католический крест
  'th': '/',       // наклонная палка
  'f': '\\',       // наклонная палка (другая сторона)
  'x': '♢',        // ромб
  's': 's',        // пока стандартная
  'z': 'z',        // пока стандартная
  'p': 'p',        // пока стандартная
  'b': 'b',        // пока стандартная
  'v': 'v',        // пока стандартная
  'w': 'w',        // пока стандартная
  'y': 'y',        // пока стандартная
  'c': 'c',        // пока стандартная
  'j': 'j',        // пока стандартная
  'q': 'q',        // пока стандартная
  
  // Гласные (будут накладываться поверх согласных)
  'a': 'ˌ',        // как запятая сверху символа
  'ā': 'ˈ',        // как символ приставки
  'o': '∪',        // перевёрнутая скобка, похожа на "U"
  'ō': '∩',        // перевёрнутая буква U
