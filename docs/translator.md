...
// === ДИАЛЕКТЫ (замена русских диалектов) ===
  ...
  // === НОВЫЕ СЛОВА ИЗ СТАТЕЙ (добавлено 28.06.2026) ===
...
"тарсису": { root: "Tarsis", pos: "noun" },
"тарсисом": { root: "Tarsis", pos: "noun" },
"тарсисе": { root: "Tarsis", pos: "noun" },
...
"сарума великого": { root: "Sarum", pos: "noun" },
